from lib.queries import CREATE_CAT_TABLE, CREATE_PROD_TABLE, CREATE_CAT_PROD_TABLE, QUERY_ADD_PROD, QUERY_ADD_CAT, QUERY_ADD_CAT_PROD, QUERY_GET_PRODS, QUERY_GET_PROD_NUTRI, QUERY_SEARCH_NAME, QUERY_GET_CATS, QUERY_COMPARE_SCORE, QUERY_UPDATE_PROD, QUERY_GET_CAT_PRODS
